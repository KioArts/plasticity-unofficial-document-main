...
4. Set the options in the Command Dialog and Keyboard Shortcuts.
   - <Kst>Command Dialog</Kst>
      ...
      - **Twist:** Specify the scale value on the ending point of the sweep. Click on the option dialog and manually enter your value or drag with your mouse from left to right.
      - **Alignment:** 
