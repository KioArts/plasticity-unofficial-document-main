...
Enhanced sketch operations to confirm with a single **enter** press or single left-click. These affect the following sketch tools: all **circle tools** (), **Regular polygon**, and all **rectangle tools** 
...
Centre circle, Two point circle, Three point circle, Tangent circle, Centre-point arc, Three point arc, Tangent arc
(Corner rectangle, Centre rectangle, Three point rectangle).
