...
Added new shaders for isophotes and draft angle analysis and new built-in matcaps for advanced surfacing workflows, including the option to insert custom matcaps. 
...
### Pipe Gizmo
 ...
 Simplified the Pipe Command gizmo.
