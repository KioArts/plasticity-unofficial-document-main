...
<VideoPlayer fileNam="tangent-circle"/>
...
New faceting preference "Ultra" has been introduced to enhance surface smoothness in surfacing workflows. It is recommended to use this when working on small documents, for example, a car body. It is CPU and GPU resource intense.
...
Enhanced sketch operations to confirm with a single **enter** press or single left-click. These affect the following sketch tools: all **circle tools** (Centre circle, Two point circle, Three point circle, Tangent circle, Centre-point arc, Three point arc, Tangent arc), **Regular polygon**, and all **rectangle tools** (Corner rectangle, Centre rectangle, Three point rectangle).
