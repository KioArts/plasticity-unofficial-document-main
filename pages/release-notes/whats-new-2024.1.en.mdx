...
Plasticity now features the xNURBS addo enabling the creation of high-quality surfaces. xNURBS is a powerful tool that enhances the ability to design smooth, complex surfaces with precision that greatly improves the overall design process. For more information on xNURBS click [here](/solid/xnurbs).
